@extends('layouts.master') <!--includes-->
    ...
    <div class="row">
        <div class ="col-md-6">
            ...
            <form action="{{ route('signup') }}" method="post">
                ...
                <div class = "form-group">
                    ...
                    <input class="form-control {{ $errors->has('first_name') ? 'has-error' : ''}}" type="text" name="first_name" id="first_name" value="{{Request::old('first_name')}}">
                </div>
                <div class = "form-group">
        ...
        <div class ="col-md-6">
            ...
            <form action="{{ route('signin') }}" method="post">
                ...
                <button type ="submit" class = "btn btn-primary">Submit</button>
                <input type="hidden" name="_token" value="{{ Session::token() }}"> <!-- if not will get token message error-->
            </form>
        </div>
    </div>
@endsection